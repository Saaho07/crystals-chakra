...
export default function Services() {
  return (
    <div className="relative min-h-screen bg-chakra-bg overflow-hidden flex flex-col pt-24 sm:pt-32 pb-24 px-4 sm:px-6 lg:px-8">
      <PageMeta 
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="text-center mb-10 sm:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold mb-4 sm:mb-6 gold-gradient-text">Our Kundli Services</h1>
          <p className="text-lg sm:text-xl text-chakra-muted max-w-3xl mx-auto">
